...
$imgPath = "imgs/logoKlein.png"; // shoud be in the img folder
$title = "Willkommen im CodingSpace.";

// the class "hervorheben" -> mark the words
$mainText = "
            Hallo, ich bin Elias,
            <br>
...
$conection = "Sie haben Fragen, Ideen und möchten sich mit mir in Verbindung setzten?";
